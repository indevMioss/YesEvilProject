 ...
 * @author Nathan Sweet */
abstract public class AdvPool<T> {
    ...
    public AdvPool(Class<T> typeParameterClass) {
        this(16, typeParameterClass, Integer.MAX_VALUE);
    }

    /** Creates a pool with the specified initial capacity and no maximum. */
    public AdvPool(int initialCapacity, Class<T> typeParameterClass) {
        this(initialCapacity, typeParameterClass, Integer.MAX_VALUE);
    }

    /**
     * @param typeParameterClass
     * @param max The maximum number of free objects to store in this pool.  */
    public AdvPool(int initialCapacity, Class<T> typeParameterClass, int max) {
